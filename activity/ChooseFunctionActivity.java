...
public class ChooseFunctionActivity extends BaseActivity {
    ...
    public void jumpToFaceRecognizeActivity(View view) {
        ...
        checkLibraryAndJumpTwoThings(RegisterAndRecognizeActivity.class, 0);
    }
    ...
    public void jumpToIrFaceRecognizeActivity(View view) {
        final EditText passWordEntering = (EditText)findViewById(R.id.editTextTextPassword);
        String getpassword = passWordEntering.getText().toString();
        if(getpassword.equals(password)){
            passed = true;
            passWordEntering.setText("");
        }
        else {
        ...
        if (passed == true) {
            checkLibraryAndJumpTwoThings(RegisterAndRecognizeActivity.class, 1);
            passed = false;
        }
    ...
    void checkLibraryAndJumpTwoThings(Class activityClass, int Type) {
        if (!libraryExists) {
            showToast(getString(R.string.library_not_found));
            return;
        }
