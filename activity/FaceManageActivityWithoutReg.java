 ...
 * 批量注册页面
 */
public class FaceManageActivityWithoutReg extends BaseActivity {
    //注册图所在的目录
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < totalCount; i++) {
                    ...
                    boolean success = FaceServer.getInstance().registerBgr24(FaceManageActivityWitoutReg.this, bgr24, bitmap.getWidth(), bitmap.getHeight(),
                ...
                Log.i(FaceManageActivityWitoutReg.class.getSimpleName(), "run: " + executorService.isShutdown());
            }
        });*/
    }
            ...
            AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            int deleteCount = FaceServer.getInstance().clearAllFaces(FaceManageActivityWitoutReg.this);
